    ...
    return (
        <div className="row py-5 justify-content-center align-items-center min-vh-90" id="me">
            <div className="col-md-6 col-12 text-white pt-5 px-4">
                ...
                <h1 className="light-on py-4 mb-4" data-aos="fade-up" data-aos-duration="1000">
            ...
            <div className="col-9 pt-md-5 px-4" data-aos="fade-up" data-aos-duration="1000">
                ...
                <div className="row pt-5 pt-md-0 justify-content-evenly text-white align-items-center" data-aos="fade-up" data-aos-duration="1000">
